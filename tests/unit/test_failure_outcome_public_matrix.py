...
def test_generation_preserves_published_bytes_when_post_publication_parse_fails(
    ...
    def quantize(*_args: object, **_kwargs: object) -> TrafficTrace:
        return TrafficTrace.from_events(())
    ...
    monkeypatch.setattr(generation, "quantize_generated_trace", quantize)
    monkeypatch.setattr(generation, "encode_pcapng_trace", encode)
    monkeypatch.setattr(generation, "publish_generated_pcapng", publish)
    monkeypatch.setattr(generation, "parse_pcapng_bytes_trace", parse_failure)
