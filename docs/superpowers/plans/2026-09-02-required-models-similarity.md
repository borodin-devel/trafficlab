...
- [x] **[STEP-1-111c47f1] Write failing structural-config and coordinate-contract tests**
...
- [x] **[STEP-2-8815164b] Run the focused tests and preserve the expected red evidence**
...
- [x] **[STEP-3-ff1226dd] Add family coordinate declarations**
...
- [x] **[STEP-4-6176b37e] Add strict required-family configuration models**
...
- [x] **[STEP-5-167183e8] Generalize bound and coordinate plumbing without registering incomplete families**
...
- [x] **[STEP-6-8f78d252] Update the genetic coordinate documentation**
...
- [x] **[STEP-7-f87fe2c4] Run the Small tier for the shared contract**
...
- [x] **[STEP-8-68c0ff55] Run the first Medium contract gate**
...
- [x] **[STEP-9-1fc7cfc3] Request independent review and fix all blocking findings**
...
- [x] **[STEP-10-3e7001ec] Commit coordinate metadata and config value types**
...
- [x] **[STEP-11-4977317a] Write hand-calculated failing ECDF tests**
...
- [x] **[STEP-12-d07e60c0] Run ECDF tests red**
...
- [x] **[STEP-13-a7795056] Implement the shared tie-aware pooled ECDF scan**
...
- [x] **[STEP-14-391dc5f5] Implement trace-level feature aggregation and typed diagnostics**
...
- [x] **[STEP-15-4e1af563] Add independent scientific formulas to tests**
...
- [x] **[STEP-16-d713a4d9] Write normative algorithm documents**
...
- [x] **[STEP-17-a014944f] Run the ECDF Small tier**
...
- [x] **[STEP-18-30ab89de] Review, fix, and commit ECDF methods**
...
- [x] **[STEP-19-47acb948] Write failing exact-JSD tests**
...
- [x] **[STEP-20-155d522f] Write failing deterministic-MMD tests**
...
- [x] **[STEP-21-625a62b9] Run JSD/MMD tests red**
...
- [x] **[STEP-22-fb533303] Implement exact aligned PMFs and base-2 JSD**
...
- [x] **[STEP-23-8c540395] Implement streaming unit-norm random Fourier features**
...
- [x] **[STEP-24-12309636] Add independent JSD and Fourier-feature oracles**
...
- [x] **[STEP-25-6537a6a0] Document both algorithms and configuration choices**
...
- [x] **[STEP-26-fc3ef71a] Run the JSD/MMD Small tier**
...
- [x] **[STEP-27-8b39c78c] Review, fix, and commit JSD/MMD**
...
- [x] **[STEP-28-1b86da1d] Write failing eight-method aggregate and checkpoint tests**
...
- [x] **[STEP-29-6c81ea8b] Run the integration tests red**
...
- [x] **[STEP-30-0c46636e] Add typed diagnostics and method registry constants**
...
- [x] **[STEP-31-7b4153f8] Wire all eight methods into fitness evaluation**
...
- [x] **[STEP-32-e2480242] Widen checkpoint and resume compatibility**
...
- [x] **[STEP-33-954f32d4] Update comparison codec/publication arithmetic**
...
- [x] **[STEP-34-0b2ba777] Update normative system and similarity contracts**
...
- [x] **[STEP-35-7c2c97e1] Run the weighted-fitness Medium gate**
...
- [x] **[STEP-36-e525c65b] Measure changed-package branch coverage**
...
- [x] **[STEP-37-9222f6cd] Review, fix, and commit eight-method fitness**
...
- [x] **[STEP-38-029deb5c] Write failing Fano/Allan hand cases**
...
- [x] **[STEP-39-759adbca] Write failing transition hand cases**
...
- [x] **[STEP-40-4307f5a9] Run post-fit tests red**
...
- [x] **[STEP-41-3400c53f] Implement dispersion curves**
...
- [x] **[STEP-42-ad099485] Implement reference-frozen transition fidelity**
...
- [x] **[STEP-43-da0ea413] Add independent count and transition oracles**
...
- [x] **[STEP-44-446a31b0] Document post-fit semantics**
...
- [x] **[STEP-45-336d0126] Run the post-fit Small tier**
...
- [x] **[STEP-46-aa64509c] Review, fix, and commit dispersion/transition diagnostics**
...
- [x] **[STEP-47-dd63600a] Write failing blocked-window and logistic tests**
...
- [x] **[STEP-48-4ddc7d9b] Run C2ST and artifact tests red**
...
- [x] **[STEP-49-3adb4d0d] Implement fixed window features and guarded folds**
...
- [x] **[STEP-50-5a1cc4e8] Implement deterministic L2 logistic regression and AUC**
...
- [x] **[STEP-51-2d1bf47e] Add the final-only comparison boundary**
...
- [x] **[STEP-52-b412a5c4] Extend strict comparison publication**
...
- [x] **[STEP-53-c3159552] Document C2ST and artifact separation**
...
- [x] **[STEP-54-5d7100f1] Run the post-fit Medium gate**
...
- [x] **[STEP-55-2a763067] Review and fix the complete post-fit subsystem**
...
- [x] **[STEP-56-b37f61dd] Commit C2ST and post-fit publication**
...
- [x] **[STEP-57-c478514b] Write failing dashboard loader/aspect tests**
...
- [x] **[STEP-58-54c74cda] Run dashboard tests red**
...
- [x] **[STEP-59-23c07c4c] Extend immutable dashboard run data**
...
- [x] **[STEP-60-7131972b] Add three run-level aspect calculators/renderers**
...
- [x] **[STEP-61-0636a7bd] Update visualization architecture**
...
- [x] **[STEP-62-9f3ff607] Run the dashboard Small tier**
...
- [x] **[STEP-63-e838c691] Run one headless schema-5 aspect smoke**
...
- [x] **[STEP-64-765c5332] Review and fix dashboard ownership**
...
- [x] **[STEP-65-015b63a4] Commit dashboard support**
...
- [x] **[STEP-66-9852321e] Write failing NHPP fit/generation/codec tests**
...
- [x] **[STEP-67-ef550288] Add independent NHPP scientific oracles**
...
- [x] **[STEP-68-7fea1f19] Run NHPP tests red**
...
- [x] **[STEP-69-08ed2f8f] Implement deterministic NHPP fit and payload validation**
...
- [x] **[STEP-70-682aa66a] Implement exact complete-window NHPP generation**
...
- [x] **[STEP-71-1f2d96fc] Integrate registry and fitted-model codecs**
...
- [x] **[STEP-72-8624c746] Write the NHPP architecture document**
...
- [x] **[STEP-73-f123f7d0] Run the NHPP Small tier**
...
- [x] **[STEP-74-6f476273] Review, fix, and commit NHPP**
...
- [x] **[STEP-75-184052e5] Write failing ACD recursion, likelihood, and repair tests**
...
- [x] **[STEP-76-8149035f] Add independent ACD scientific oracles**
...
- [x] **[STEP-77-f64e33c9] Run ACD tests red**
...
- [x] **[STEP-78-66f12e58] Implement constrained deterministic ACD fitting**
...
- [x] **[STEP-79-11f61ece] Implement ACD generation and strict payload**
...
- [x] **[STEP-80-efb2baa5] Write the ACD architecture document**
...
- [x] **[STEP-81-98b58a33] Run the two-family Medium gate**
...
- [x] **[STEP-82-01bcdb89] Review and fix NHPP/ACD integration**
...
- [x] **[STEP-84-e8df7ebc] Write failing segmentation and state tests**
...
- [x] **[STEP-85-9fd84e2a] Write failing generation/fallback/codec tests**
...
- [x] **[STEP-86-06d11f90] Add independent packet-train oracles**
...
- [x] **[STEP-87-71d62f06] Run train tests red**
...
- [x] **[STEP-88-e1693297] Implement segmentation, fitted state, and payload**
...
- [x] **[STEP-89-966e0201] Implement train-by-train generation**
...
- [x] **[STEP-90-f6a98be4] Integrate codecs and write architecture**
...
- [x] **[STEP-91-81aebb72] Run the packet-train Small tier and review**
...
- [x] **[STEP-92-18a7eac8] Commit packet trains**
...
- [x] **[STEP-93-6fa0da5e] Write failing vocabulary and tiny-likelihood tests**
...
- [x] **[STEP-94-f1c44ffd] Write failing EM/generation/codec tests**
...
- [x] **[STEP-95-86c37f6b] Add independent HMM scientific oracles**
...
- [x] **[STEP-96-1fca2ed1] Run HMM tests red**
...
- [x] **[STEP-97-68cd1e47] Implement stable deterministic HMM inference**
...
- [x] **[STEP-98-f87203d6] Implement fitted payload and generation**
...
- [x] **[STEP-99-8f753340] Integrate codecs and write HMM architecture**
...
- [x] **[STEP-100-5d590173] Run the seven-family Medium gate**
...
- [x] **[STEP-101-2a5e31e5] Review, fix, and commit packet HMM**
...
- [x] **[STEP-102-b357605f] Write failing default/schema inventory tests**
...
- [x] **[STEP-103-c45050c9] Run inventory tests red**
...
- [x] **[STEP-104-5a34c56a] Update defaults and deterministic generators**
...
- [x] **[STEP-105-2d33f5fc] Generate schema-5 assets twice and compare bytes**
...
- [x] **[STEP-106-b43aa446] Remove implemented entries from the candidate catalog**
...
- [x] **[STEP-107-c33d94d0] Run the schema/default Medium gate**
...
- [x] **[STEP-108-53828941] Audit immutable historical evidence**
...
- [x] **[STEP-109-2485b9d7] Review and fix schema-5 assets/documentation**
...
- [x] **[STEP-110-44423032] Commit schema-5 release assets**
...
- [x] **[STEP-111-334500a4] Write failing derivation and profile tests**
...
- [x] **[STEP-112-aa4c511e] Run tooling tests red**

```bash
uv run --locked pytest -q tests/unit/tooling/test_derive_required_candidates_reference.py
```

- [x] **[STEP-113-dd4b6188] Implement bounded derivation and manifests**
...
- [x] **[STEP-114-432ff42b] Add three exact experiment profiles and instructions**
...
- [x] **[STEP-115-3428c4bd] Run the tooling Small tier and derive local inputs**
...
- [x] **[STEP-116-ad219507] Review, fix, and commit experiment tooling**
...
- [x] **[STEP-125-1f05977e] Commit, push, and report the clean feature head**
