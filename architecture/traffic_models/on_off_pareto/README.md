# ON/OFF Pareto Traffic Model — Unresolved

## Purpose and Status

The planned `on_off_pareto` component would represent alternating active and
idle periods with heavy-tailed durations. It is a research stub, not registered
or selectable.

## Inputs, Outputs, and Dependencies

Period laws, within-ON arrivals/sizes, boundary semantics, fitting, generation,
schema, and numerical limits are unresolved.
