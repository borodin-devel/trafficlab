...
Trafficlab поставляется как один Python-дистрибутив. Исходный код находится только в `src/trafficlab/`. Конфигурации, схемы, тесты и проектные ресурсы не становятся неявными зависимостями библиотечного кода.
...
- `scripts/` содержит только ограниченные операции установки, предварительной проверки и очистки. Рабочая логика принадлежит пакету.
